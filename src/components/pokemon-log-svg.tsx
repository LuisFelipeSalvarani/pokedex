...
export function PokemonLogoSvg(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      id="Layer_1"
    ...
    >
      ...
      <style>
        {
          '.st3{fill:#1d2c5e}.st7{fill:#21386e}.st12{fill:#7d7f68}.st13{fill:#c7a008}'
        }
      </style>
      <linearGradient
        id="polygon16_1_"
      ...
      <path
        ...
        fill="url(#polygon25_1_)"
      />
      <path id="polygon27" className="st3" d="M244.1 31.3l4.5-2.4-1.3 11.4z" />
      <path
        id="polygon29"
        className="st3"
      ...
      <path id="path88" className="st12" d="M152.4 47l-.2.2c.1 0 .2-.1.2-.2z" />
      <path
        id="polygon90"
        className="st12"
